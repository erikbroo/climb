...
//
// /**
// * A random number sequence generator. This class is capable of efficiently
// * generating a random sequence of integers. In contrast to java.util.random,
// * this class allows to retrieve a random number for a specific index. The
// same
// * RandomSequence instance will always generate the same number for the same
// * index, however the numbers generated for different indices will be randomly
// * different. Two different RandomSequence instances will generate different
// * sequences, if they are created and initialized with different seeds.
// */
// public class RandomSequence
// {
// private final static volatile long seedUniquifier = 8682522807148012L;
//
...
//
// /**
// * Creates a new random number sequence generator. This constructor sets the
// * seed of the random number sequence generator to a value very likely to be
// * distinct from any other invocation of this constructor.
// */
// public RandomSequence()
// {
// this(++RandomSequence.seedUniquifier + System.nanoTime());
// }
//
// /**
// * Creates a new random number sequence generator using a single
// * {@code long} seed. Two instances created with the same seed will generate
...
// size="-1"><sup>-24</sup></font>,
// * where <i>m</i> is a positive integer less than 2<font
// size="-1"><sup>24</sup>
...
// s = v1 * v1 + v2 * v2;
// } while ((s >= 1) || (s == 0));
// final double multiplier = StrictMath.sqrt(-2 * StrictMath.log(s)
// / s);
...
// try {
// seedOffset =
// RandomSequence.unsafe.objectFieldOffset(Random.class.getDeclaredField("seed"));
...
// {
// RandomSequence.unsafe.putObjectVolatile(this,
// RandomSequence.seedOffset, new AtomicLong(seedVal));
// }
// }
